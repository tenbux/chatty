/**
 * From https://github.com/rtyley/animated-gif-lib-for-java/blob/master/src/main/java/com/madgag/gif/fmsware/GifDecoder.java
 * (Original release seems to be no longer available.)
 * 
 * Includes some modifications by rtyley (Apache V2 licence), as stated on the
 * above repository.
 * 
 * Additional modification by tduva to fix restore to previous disposal bug.
 * 
 * (Renamed class and package.)
 */

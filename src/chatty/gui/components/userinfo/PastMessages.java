...
public class PastMessages extends JTextArea {
    ...
    public final static int CURRENT_MSG = 1;
    ...
    private void addSourceChannel(User.Message m, StringBuilder b) {
        if (m instanceof User.SharedMessage sm) {

...
public class IgnoreSettings extends SettingsPanel {
    ...
    public IgnoreSettings(SettingsDialog d) {
        ...
        gbc = SettingsDialog.makeGbc(2, 1, 1, 1, GridBagConstraints.EAST);
        gbc.weightx = 1;
        ...
        gbc = SettingsDialog.makeGbc(0, 2, 4, 1, GridBagConstraints.EAST);
        gbc.insets = new Insets(0, 5, 4, 4);
        base.add(ignoreShowNotDialog, gbc);
        
        gbc = SettingsDialog.makeGbc(0, 1, 2, 1, GridBagConstraints.EAST);
        gbc.insets = new Insets(0,12,2,5);
        ...
        ignoredUsersButton.addActionListener(e -> ignoredUsers.show(IgnoreSettings.this));

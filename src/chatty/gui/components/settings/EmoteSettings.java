...
public class EmoteSettings extends SettingsPanel {
    ...
    protected EmoteSettings(SettingsDialog d) {
        ...
        main.add(ignoredEmotesButton,
                SettingsDialog.makeGbc(2, 0, 3, 1, GridBagConstraints.EAST));
        ...
        main.add(emoteScale, SettingsDialog.makeGbc(1, 3, 1, 1, GridBagConstraints.WEST));
        ...
        main.add(emoteScaleGigantified, SettingsDialog.makeGbc(1, 4, 1, 1, GridBagConstraints.WEST));
        ...
        main.add(emoteScaleDialog, SettingsDialog.makeGbc(1, 5, 1, 1, GridBagConstraints.WEST));
        ...
        twitchSettings.add(new JLabel(Language.getString("settings.emoticons.cheers")),
                SettingsDialog.makeGbc(0, 6, 1, 1, GridBagConstraints.CENTER));
        twitchSettings.add(cheersType,
                SettingsDialog.makeGbc(1, 6, 2, 1, GridBagConstraints.WEST));
        ...
        ffzSettings.add(ffzEvent,
                SettingsDialog.makeGbcSub(0, 3, 1, 1, GridBagConstraints.WEST));
...
//        b.setStringId("123abc");
    ...
    private static class LocalEmotesDialog extends LazyDialog {
        ...
        private LocalEmotesDialog(SettingsDialog d) {
            ...
            editor.setItemEditor(() -> (TableEditor.ItemEditor<Emoticon>) (preset, c, edit, column) -> {
            ...
            editor.setModel(new ListTableModel<>(new String[]{"Image", "Code", "Id"}) {

                @Override
                public Object getValueAt(int rowIndex, int columnIndex) {
                    return switch (columnIndex) {
                        case 0 -> get(rowIndex);
                        case 1 -> get(rowIndex).code;
                        case 2 -> get(rowIndex).stringId;
                        default -> null;
                    };
                }
            });
            editor.setRendererForColumn(0, new EmoteRenderer((oldImage, newImage, sizeChanged) -> editor.repaint()));
        }

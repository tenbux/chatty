...
public class LiveStreamsTitledBorder extends AbstractBorder
{
    /**
     ...
     */
    public LiveStreamsTitledBorder(String title) {
     ...
     */
    public LiveStreamsTitledBorder(Border border) {
     ...
     * @param title  the title the border should display
     */
    public LiveStreamsTitledBorder(Border border, String title) {
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        if ((title != null) && !title.isEmpty()) {
            int edge = (border instanceof LiveStreamsTitledBorder) ? 0 : EDGE_SPACING;
    ...
    private void installPropertyChangeListeners() {
        /**
         * Commented out because the fix for the memory leak uses an internal
         * API and the way this is intended to be used updating UI shouldn't be
         * necessary.
         */
